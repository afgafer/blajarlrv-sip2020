            ...
            {{csrf_field()}}
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control @error('contact') is-invalid @enderror" name="contact" placeholder="contact" required>
                        @error('contact')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message}}</strong>
                            </span>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <input type="text" class="form-control @error('lat') is-invalid @enderror" name="lat" placeholder="lat">
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <input type="text" class="form-control @error('lng') is-invalid @enderror" name="lng" placeholder="lng">
                        <span>can be empty</span>
                        @error('lng')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message}}</strong>
